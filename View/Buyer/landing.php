...
<title>Harvestly - Fresh Vegetables Direct from Sri Lankan Farmers</title>
    <link rel="stylesheet" href="<?= e(BASE_URL) ?>/css/Buyer/landing-page.css">
...
<a class="flex items-center gap-2" href="<?= e(BASE_URL) ?>/Controller/Buyer/LandingController.php">
<img alt="Harvestly Logo" class="h-8 md:h-10 object-contain" src="<?= e(BASE_URL) ?>/assets/harvestly-logo.jpeg"/>
</a>
<div class="hidden md:flex items-center gap-lg font-body-md text-body-md">
<a class="text-primary dark:text-secondary-fixed border-b-2 border-primary dark:border-secondary-fixed pb-1 active:opacity-80 transition-opacity" href="<?= e(BASE_URL) ?>/Controller/Buyer/LandingController.php">Home</a>
<a class="text-on-surface-variant dark:text-outline-variant hover:text-secondary dark:hover:text-secondary-fixed-dim transition-colors duration-200 active:opacity-80 transition-opacity" href="<?= e(BASE_URL) ?>/Controller/Buyer/ProductController.php">Products</a>
<a class="text-on-surface-variant dark:text-outline-variant hover:text-secondary dark:hover:text-secondary-fixed-dim transition-colors duration-200 active:opacity-80 transition-opacity" href="<?= e(BASE_URL) ?>/Controller/Buyer/DashboardController.php">Categories</a>
<a class="text-on-surface-variant dark:text-outline-variant hover:text-secondary dark:hover:text-secondary-fixed-dim transition-colors duration-200 active:opacity-80 transition-opacity" href="<?= e(BASE_URL) ?>/Controller/Buyer/DashboardController.php">Farmers</a>
<a class="text-on-surface-variant dark:text-outline-variant hover:text-secondary dark:hover:text-secondary-fixed-dim transition-colors duration-200 active:opacity-80 transition-opacity" href="<?= e(BASE_URL) ?>/Controller/Buyer/DashboardController.php">About</a>
</div>
<div class="flex items-center gap-sm">
<a class="hidden md:block font-label-bold text-label-bold text-primary px-4 py-2 hover:bg-surface-container rounded-full transition-colors" href="<?= e(BASE_URL) ?>/Controller/Buyer/AuthController.php">Login</a>
<a class="font-label-bold text-label-bold bg-primary text-on-primary px-6 py-2 rounded-full hover:bg-primary-container transition-colors shadow-sm" href="<?= e(BASE_URL) ?>/Controller/Buyer/RegistrationController.php">Register</a>
...
<div id="mobileMenu" class="mobile-menu" aria-hidden="true">
    <a href="<?= e(BASE_URL) ?>/Controller/Buyer/LandingController.php">Home</a>
    ...
    <a href="<?= e(BASE_URL) ?>/Controller/Buyer/DashboardController.php#farmers">Farmers</a>
    <a href="<?= e(BASE_URL) ?>/Controller/Buyer/DashboardController.php#about">About</a>
    <a href="<?= e(BASE_URL) ?>/Controller/Buyer/AuthController.php">Login</a>
    <a href="<?= e(BASE_URL) ?>/Controller/Buyer/RegistrationController.php">Register</a>
</div>
...
<a href="<?= e(BASE_URL) ?>/Controller/Buyer/ProductController.php" class="font-label-bold text-label-bold bg-primary text-on-primary px-8 py-4 rounded-full hover:bg-primary-container transition-colors shadow-md">
                            Shop Now
                        </a>
<a href="<?= e(BASE_URL) ?>/Controller/Buyer/RegistrationController.php" class="font-label-bold text-label-bold bg-surface-container-lowest text-primary border border-primary px-8 py-4 rounded-full hover:bg-surface-container-low transition-colors shadow-sm">
                            Become a Farmer
                        </a>
</div>
</div>
...
<a class="hidden md:flex items-center gap-2 font-label-bold text-label-bold text-secondary hover:text-primary transition-colors" href="<?= e(BASE_URL) ?>/Controller/Buyer/DashboardController.php">
...
<a class="font-label-bold text-label-bold text-secondary border border-secondary px-6 py-3 rounded-full hover:bg-surface-container-low transition-colors" href="<?= e(BASE_URL) ?>/Controller/Buyer/DashboardController.php">
                    View All Products
                </a>
</div>
</section>
...
<a class="font-body-sm text-body-sm text-on-primary/80 dark:text-on-tertiary/80 hover:text-secondary-fixed dark:hover:text-secondary-fixed-dim transition-colors" href="<?= e(BASE_URL) ?>/Controller/Buyer/DashboardController.php">About Harvestly</a>
<a class="font-body-sm text-body-sm text-on-primary/80 dark:text-on-tertiary/80 hover:text-secondary-fixed dark:hover:text-secondary-fixed-dim transition-colors" href="<?= e(BASE_URL) ?>/Controller/Buyer/DashboardController.php">Quick Links</a>
<a class="font-body-sm text-body-sm text-on-primary/80 dark:text-on-tertiary/80 hover:text-secondary-fixed dark:hover:text-secondary-fixed-dim transition-colors" href="<?= e(BASE_URL) ?>/Controller/Buyer/DashboardController.php">Contact Us</a>
<a class="font-body-sm text-body-sm text-on-primary/80 dark:text-on-tertiary/80 hover:text-secondary-fixed dark:hover:text-secondary-fixed-dim transition-colors" href="<?= e(BASE_URL) ?>/Controller/Buyer/DashboardController.php">Privacy Policy</a>
<a class="font-body-sm text-body-sm text-on-primary/80 dark:text-on-tertiary/80 hover:text-secondary-fixed dark:hover:text-secondary-fixed-dim transition-colors" href="<?= e(BASE_URL) ?>/Controller/Buyer/DashboardController.php">Terms of Service</a>
</div>
...
<button id="subscribeBtn" type="button" class="bg-secondary-fixed text-primary font-label-bold px-6 py-2 rounded-full hover:bg-[#2EEA92] transition-colors">
    ...
    <script src="<?= e(BASE_URL) ?>/js/Buyer/landing-page.js"></script>
</body></html>