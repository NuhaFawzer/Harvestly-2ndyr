...
<div class="page-content" style="max-width: 480px; margin: 100px auto; padding: 0 20px;">
    <div style="background-color: var(--color-surface); border: 1px solid var(--color-outline-variant); border-radius: var(--radius-xl); padding: 36px; box-shadow: var(--shadow-md);">
        <div style="text-align: center; margin-bottom: 28px;">
            ...
            <h1 style="font-size: 24px; font-weight: 800; color: var(--color-on-surface);">Reset Your Password</h1>
            <p style="font-size: 14px; color: var(--color-on-surface-variant); margin-top: 4px;">Enter your new password below</p>
        </div>
        ...
        <form action="index.php?action=reset_password" method="POST">
            ...
            <div class="form-group mb-4">
                ...
                <input type="password" id="new-password" name="new_password" class="form-control" placeholder="••••••••" required>
            </div>
        ...
        <div style="text-align: center; margin-top: 24px; font-size: 14px; color: var(--color-on-surface-variant);">
            <a href="index.php?page=login" style="color: var(--color-primary); font-weight: 700;">Back to Login</a>
        </div>
    </div>
</div>
